...
class _HomePageState extends State<HomePage> {
  ...
  late Stream<QuerySnapshot> _cerpenStream;
  ...
  void initState() {
    super.initState();
    _cerpenStream = _firestore.collection('cerpen').snapshots();
  }
  ...
  Future<void> _refreshData() async {
    ...
    // Tidak ada pembaruan logika karena StreamBuilder akan otomatis memperbarui data.
    setState(() {
      _cerpenStream = _firestore.collection('cerpen').snapshots();
    });
  }
                  ...
                  Expanded(
                    child: StreamBuilder<QuerySnapshot>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return CustomListView(items: items,isVerified: isVerified);
                      },
                    ),
                  ),
                ],
